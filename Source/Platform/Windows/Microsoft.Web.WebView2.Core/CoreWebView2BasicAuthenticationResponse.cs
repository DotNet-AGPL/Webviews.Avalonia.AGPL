...
/// <summary>Represents a Basic HTTP authentication response that contains a user name
/// and a password as according to RFC7617 (https://tools.ietf.org/html/rfc7617).</summary>
public class CoreWebView2BasicAuthenticationResponse
{
	...
	public string Password
	{
		get
		{
			...
			catch (InvalidCastException ex)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2BasicAuthenticationResponse members can only be accessed from the UI thread.", ex);
				}
				throw ex;
			}
			catch (COMException ex2)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2BasicAuthenticationResponse members cannot be accessed after the WebView2 control is disposed.", ex2);
				}
				throw ex2;
			}
		}
	...
	/// <summary>User name provided for authentication.</summary>
