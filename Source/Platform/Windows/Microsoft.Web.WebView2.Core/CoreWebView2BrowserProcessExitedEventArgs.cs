...
/// <summary>
/// Event args for the <see cref="E:Microsoft.Web.WebView2.Core.CoreWebView2Environment.BrowserProcessExited" /> event.</summary>
public class CoreWebView2BrowserProcessExitedEventArgs : EventArgs
{
	...
	/// <summary>The kind of browser process exit that has occurred.</summary>
	public CoreWebView2BrowserProcessExitKind BrowserProcessExitKind
	{
		get
		{
			...
			catch (InvalidCastException ex)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2BrowserProcessExitedEventArgs members can only be accessed from the UI thread.", ex);
				}
				throw ex;
			}
			catch (COMException ex2)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2BrowserProcessExitedEventArgs members cannot be accessed after the WebView2 control is disposed.", ex2);
				}
				throw ex2;
			}
		}
	...
	/// <summary>The process ID of the browser process that has exited.</summary>
