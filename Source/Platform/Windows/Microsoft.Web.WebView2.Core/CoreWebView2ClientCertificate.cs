...
/// <summary>Represents a client certificate that provides access to the client certificate metadata.</summary>
public class CoreWebView2ClientCertificate
{
	...
	public string DerEncodedSerialNumber
	{
		get
		{
			...
			catch (InvalidCastException ex)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2ClientCertificate members can only be accessed from the UI thread.", ex);
				}
				throw ex;
			}
			catch (COMException ex2)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2ClientCertificate members cannot be accessed after the WebView2 control is disposed.", ex2);
				}
				throw ex2;
			}
		}
	...
	/// <summary>Display name for a certificate.</summary>
	...
	/// <summary>
	/// Kind of a certificate. See <see cref="T:Microsoft.Web.WebView2.Core.CoreWebView2ClientCertificateKind" /> for descriptions.</summary>
	...
	/// <summary>
	/// Returns list of PEM encoded client certificate issuer chain. In this list first element is the current certificate followed by intermediate1, intermediate2...intermediateN-1. Root certificate is the last element in the list.</summary>
	public IReadOnlyList<string> PemEncodedIssuerCertificateChain
	{
		get
		{
			try
			{
				return COMDotNetTypeConverter.stringCollectionCOMToNet(_nativeICoreWebView2ClientCertificate.PemEncodedIssuerCertificateChain);
			}
			catch (InvalidCastException ex)
			{
				if (ex.HResult == -2147467262)
