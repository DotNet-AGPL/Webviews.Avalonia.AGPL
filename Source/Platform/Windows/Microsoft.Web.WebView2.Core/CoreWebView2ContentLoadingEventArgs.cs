...
/// <summary>
/// Event args for the <see cref="E:Microsoft.Web.WebView2.Core.CoreWebView2.ContentLoading" /> event.</summary>
public class CoreWebView2ContentLoadingEventArgs : EventArgs
{
	...
	/// <summary><c>true</c> if the loaded content is an error page.</summary>
	public bool IsErrorPage
	{
		get
		{
			...
			catch (InvalidCastException ex)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2ContentLoadingEventArgs members can only be accessed from the UI thread.", ex);
				}
				throw ex;
			}
			catch (COMException ex2)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2ContentLoadingEventArgs members cannot be accessed after the WebView2 control is disposed.", ex2);
				}
				throw ex2;
			}
		}
	...
	/// <summary>The ID of the navigation.</summary>
