...
internal class CoreWebView2CreateCoreWebView2ControllerCompletedHandler : ICoreWebView2CreateCoreWebView2ControllerCompletedHandler, INotifyCompletion
{
	...
	public CoreWebView2Controller AsyncReturnValue { get; private set; }
	...
	public void Invoke(int errCode, ICoreWebView2Controller value)
	{
		AsyncReturnValue = new CoreWebView2Controller(value);
