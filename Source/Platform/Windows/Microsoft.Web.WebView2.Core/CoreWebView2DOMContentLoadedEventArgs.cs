...
/// <summary>
/// Event args for the <see cref="E:Microsoft.Web.WebView2.Core.CoreWebView2.DOMContentLoaded" /> event.</summary>
public class CoreWebView2DOMContentLoadedEventArgs : EventArgs
{
	...
	/// <summary>The ID of the navigation which corresponds to other navigation ID properties on other navigation events.</summary>
	public ulong NavigationId
	{
		get
		{
			...
			catch (InvalidCastException ex)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2DOMContentLoadedEventArgs members can only be accessed from the UI thread.", ex);
				}
				throw ex;
			}
			catch (COMException ex2)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2DOMContentLoadedEventArgs members cannot be accessed after the WebView2 control is disposed.", ex2);
				}
				throw ex2;
			}
		}
