...
/// <summary>
/// Event args for the <see cref="E:Microsoft.Web.WebView2.Core.CoreWebView2.FrameCreated" /> event.</summary>
public class CoreWebView2FrameCreatedEventArgs : EventArgs
{
	...
	/// </summary><seealso cref="T:Microsoft.Web.WebView2.Core.CoreWebView2Frame" />
	public CoreWebView2Frame Frame
	{
		get
		{
			...
			catch (InvalidCastException ex)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2FrameCreatedEventArgs members can only be accessed from the UI thread.", ex);
				}
				throw ex;
			}
			catch (COMException ex2)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2FrameCreatedEventArgs members cannot be accessed after the WebView2 control is disposed.", ex2);
				}
				throw ex2;
			}
		}
