...
/// <summary>
/// Provides a set of properties for a process list in the <see cref="T:Microsoft.Web.WebView2.Core.CoreWebView2Environment" />.</summary>
public class CoreWebView2ProcessInfo
{
	...
	/// <summary>The kind of the process.</summary>
	public CoreWebView2ProcessKind Kind
	{
		get
		{
			...
			catch (InvalidCastException ex)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2ProcessInfo members can only be accessed from the UI thread.", ex);
				}
				throw ex;
			}
			catch (COMException ex2)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2ProcessInfo members cannot be accessed after the WebView2 control is disposed.", ex2);
				}
				throw ex2;
			}
		}
	...
	/// <summary>The process id of the process.</summary>
