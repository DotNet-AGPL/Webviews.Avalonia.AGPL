...
/// <summary>
/// Event args for the <see cref="E:Microsoft.Web.WebView2.Core.CoreWebView2.SourceChanged" /> event.</summary>
public class CoreWebView2SourceChangedEventArgs : EventArgs
{
	...
	/// <summary><c>true</c> if the page being navigated to is a new document.</summary>
	public bool IsNewDocument
	{
		get
		{
			...
			catch (InvalidCastException ex)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2SourceChangedEventArgs members can only be accessed from the UI thread.", ex);
				}
				throw ex;
			}
			catch (COMException ex2)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2SourceChangedEventArgs members cannot be accessed after the WebView2 control is disposed.", ex2);
				}
				throw ex2;
			}
		}
