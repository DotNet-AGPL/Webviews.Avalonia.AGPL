...
/// <summary>
/// An HTTP response used with the <see cref="E:Microsoft.Web.WebView2.Core.CoreWebView2.WebResourceRequested" /> event.</summary>
public class CoreWebView2WebResourceResponse
{
	...
	public Stream Content
	{
		get
		{
			...
			catch (InvalidCastException ex)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2WebResourceResponse members can only be accessed from the UI thread.", ex);
				}
				throw ex;
			}
			catch (COMException ex2)
			{
				...
				{
					throw new InvalidOperationException("CoreWebView2WebResourceResponse members cannot be accessed after the WebView2 control is disposed.", ex2);
				}
				throw ex2;
			}
		}
		set
		{
			try
			{
				_nativeICoreWebView2WebResourceResponse.Content = ((value == null) ? null : new ManagedIStream(value));
			}
			catch (InvalidCastException ex)
			{
				if (ex.HResult == -2147467262)
	...
	/// <summary>Overridden HTTP response headers.</summary>
